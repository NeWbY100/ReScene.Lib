...
internal interface IContainerRebuilder
{
    ...
    /// <param name="tracks">Track data blocks keyed by track number.</param>
    /// <param name="mediaFilePath">Path to the full original media file.</param>
    /// <param name="trackOffsets">Found signature offsets keyed by track number.</param>
    /// <param name="outputPath">Path to write the reconstructed sample.</param>
    /// <param name="reportProgress">Optional callback to report progress (phase, trackNumber, totalTracks, percent).</param>
