...
public class SRSFile
{
    ...
    {
        EBMLIds.EBML => "EBML",
        EBMLIds.EBMLVersion => "EBMLVersion",
        EBMLIds.EBMLReadVersion => "EBMLReadVersion",
        EBMLIds.EBMLMaxIDLength => "EBMLMaxIDLength",
        EBMLIds.EBMLMaxSizeLength => "EBMLMaxSizeLength",
        EBMLIds.DocType => "DocType",
        EBMLIds.DocTypeVersion => "DocTypeVersion",
        EBMLIds.DocTypeReadVersion => "DocTypeReadVersion",
        EBMLIds.Segment => "Segment",
        EBMLIds.SeekHead => "SeekHead",
        EBMLIds.Info => "Info",
        EBMLIds.Tracks => "Tracks",
        EBMLIds.Cluster => "Cluster",
        EBMLIds.Cues => "Cues",
        EBMLIds.Attachments => "Attachments",
        EBMLIds.Chapters => "Chapters",
        EBMLIds.Tags => "Tags",
        EBMLIds.ReSampleContainer => "ReSample",
        _ => $"Element 0x{id:X}"
    };
}
