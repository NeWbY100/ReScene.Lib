...
internal enum RAR4BlockType : byte
{
    ...
    /// <summary>
    /// Main archive header (HEAD3_MAIN).
    /// </summary>
    ArchiveHeader = 0x73,

    /// <summary>
    /// File header (HEAD3_FILE).
    /// </summary>
    FileHeader = 0x74,

    /// <summary>
    /// Old-style comment block (HEAD3_CMT).
    /// </summary>
    Comment = 0x75,

    /// <summary>
    /// Old-style authenticity verification (HEAD3_AV).
    /// </summary>
    AuthInfo = 0x76,

    /// <summary>
    /// Old-style subblock (HEAD3_OLDSERVICE).
    /// </summary>
    OldService = 0x77,

    /// <summary>
    /// Recovery record (HEAD3_PROTECT).
    /// </summary>
    Protect = 0x78,

    /// <summary>
    /// Digital signature (HEAD3_SIGN).
    /// </summary>
    Sign = 0x79,

    /// <summary>
    /// Service header/subheader (HEAD3_SERVICE).
    /// </summary>
    Service = 0x7A,

    /// <summary>
    /// End of archive marker (HEAD3_ENDARC).
    /// </summary>
    EndArchive = 0x7B
}
